...
const defaultTestimonials = [
  {
    ...
    name: 'Sarah Mitchell',
    rating: 5,
    quote: 'Absolutely love the quality. Every piece feels luxurious and the attention to detail is remarkable.',
  ...
  },
  {
    ...
    name: 'James Chen',
    rating: 5,
    quote: 'The best online shopping experience I have ever had. Fast shipping and the products exceeded my expectations.',
  ...
  },
  {
    ...
    name: 'Elena Rossi',
    rating: 4,
    quote: 'Beautiful craftsmanship and sustainable materials. I feel good about every purchase I make here.',
  ...
  },
  {
    ...
    name: 'David Park',
    rating: 5,
    quote: 'Incredible fit and timeless style. These pieces have become staples in my wardrobe.',
  ...
  },
  {
    ...
    name: 'Amara Johnson',
    rating: 5,
    quote: 'Customer service is top-notch. They helped me find the perfect size and the return process was seamless.',
    location: 'London, UK',
    product: 'Silk Blouse',
  },
  {
    ...
    name: 'Luca Moretti',
    rating: 4,
    quote: 'Stylish, comfortable, and well-made. I have recommended this brand to all my friends.',
    location: 'Rome, Italy',
    product: 'Cotton Polo',
  },
];

export default function TestimonialsCarousel({ testimonials = defaultTestimonials }) {
